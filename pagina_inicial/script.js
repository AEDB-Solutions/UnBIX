...
function initMap()
{
  ...
  var map = new google.maps.Map(document.getElementById('map-canvas'), options);
    ...
    load_on_map(map,"http://localhost/unbix/UnBiX/UnBiiX/UnBiiiX/UnBIX/pagina_inicial/loc_1.php");
    load_on_map(map,"http://localhost/unbix/UnBiX/UnBiiX/UnBiiiX/UnBIX/pagina_inicial/loc_0.php");
